...
#pragma warning disable xUnit1026 // Theory methods should use all of their parameters
        public Task SendToRecvFrom_Datagram_UDP(IPAddress loopbackAddress, bool useClone, int dummy)
#pragma warning restore xUnit1026 // Theory methods should use all of their parameters
        {
            return UdpStressRepro.SendToRecvFrom_Datagram_UDP(loopbackAddress, useClone, _socketHelper, _output);
        }
