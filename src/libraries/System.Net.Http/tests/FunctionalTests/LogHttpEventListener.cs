...
namespace System.Net.Http.Functional.Tests
{
    ...
    {
        public const string LogDirectory = @"c:\_dev\r7d\src\libraries\System.Net.Http\tests\FunctionalTests\_log";
        ...
        {
            string fn = Path.Combine(LogDirectory, $"{Prefix}_{++_lastLogNumber:000}.log");
            if (File.Exists(fn))
            {
                File.Delete(fn);
            }
        ...
        private char RC() => (char)((int)'a' + Random.Shared.Next('z' - 'a'));
        ...
        {
            StringBuilder sb = Interlocked.Exchange(ref _cachedStringBuilder, null) ?? new StringBuilder(64);
